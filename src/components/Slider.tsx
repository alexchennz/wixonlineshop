...
export default function Slider() {
    ...
    return (
        <div className="h-[calc(100vh-80px)] overflow-hidden">
            <div className="w-max h-full flex transition-all duration-1000 ease-in-out" style={{transform: `translateX(-${current * 100}vw)`}}>
                {slides.map((slide) => (
                    <div className="`${slider.bg}` w-screen h-full flex flex-col gap-16 xl:flex-row" key={slide.id}>
                        {/* TEXT CONTAINER */}
